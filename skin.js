...
// Pano2VR 6.0.1/17227
// Filename: skin-1.ggsk
// Generated Thu Apr 9 15:00:49 2020
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._video_popup_file0=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._video_popup_file0.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._video_popup_file0.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_video_popup_file') == true)
			)
			...
			if (me._video_popup_file0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._video_popup_file0.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._video_popup_file0.style[domTransition]='';
				if (me._video_popup_file0.ggCurrentLogicStateVisible == 0) {
					me._video_popup_file0.style.visibility=(Number(me._video_popup_file0.style.opacity)>0||!me._video_popup_file0.style.opacity)?'inherit':'hidden';
					me._video_popup_file0.ggVisible=true;
				}
				else {
					me._video_popup_file0.style.visibility="hidden";
					me._video_popup_file0.ggVisible=false;
				}
			}
		}
		me._video_popup_file0.ggUpdatePosition=function (useTransition) {
		}
		el=me._loading_video_file0=document.createElement('div');
		els=me._loading_video_file0__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			...
			''+
			'';
		me._loading_video_file0__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_video_file0;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._loading_video_file0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._loading_video_file0.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._video_popup_file0.appendChild(me._loading_video_file0);
		el=me._popup_video_file0=document.createElement('div');
		me._popup_video_file0.seekbars = [];
		me._popup_video_file0.seekbars.push('seekbar_file');
		me._popup_video_file0.seekbars.push('seekbar_file');
		me._popup_video_file0.ggInitMedia = function(media) {
			var notifySeekbars = function() {
				for (var i = 0; i < me._popup_video_file0.seekbars.length; i++) {
					var seekbar = me.findElements(me._popup_video_file0.seekbars[i]);
					if (seekbar.length > 0) seekbar[0].connectToMediaEl();
				}
			}
			while (me._popup_video_file0.hasChildNodes()) {
				me._popup_video_file0.removeChild(me._popup_video_file0.lastChild);
			}
			if (me._popup_video_file0__vid) {
				me._popup_video_file0__vid.pause();
			}
			if(media == '') {
				notifySeekbars();
				me._popup_video_file0.ggVideoNotLoaded = true;
				return;
			}
			me._popup_video_file0.ggVideoNotLoaded = false;
			me._popup_video_file0__vid=document.createElement('video');
			me._popup_video_file0__vid.className='ggskin ggskin_video';
			me._popup_video_file0__vid.setAttribute('width', '100%');
			me._popup_video_file0__vid.setAttribute('height', '100%');
			me._popup_video_file0__vid.setAttribute('autoplay', '');
			me._popup_video_file0__source=document.createElement('source');
			me._popup_video_file0__source.setAttribute('src', media);
			me._popup_video_file0__vid.setAttribute('playsinline', 'playsinline');
			me._popup_video_file0__vid.setAttribute('style', ';');
			me._popup_video_file0__vid.appendChild(me._popup_video_file0__source);
			me._popup_video_file0.appendChild(me._popup_video_file0__vid);
			var videoEl = player.registerVideoElement('popup_video_file', me._popup_video_file0__vid);
			videoEl.autoplay = true;
			notifySeekbars();
			me._popup_video_file0.ggVideoSource = media;
		}
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._popup_video_file0.ggIsActive=function() {
			if (me._popup_video_file0__vid != null) {
				return (me._popup_video_file0__vid.paused == false && me._popup_video_file0__vid.ended == false);
			} else {
				return false;
			}
		}
		...
		me._popup_video_file0.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_video_popup_file') == true)
			)
			...
			if (me._popup_video_file0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._popup_video_file0.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._popup_video_file0.style[domTransition]='';
				if (me._popup_video_file0.ggCurrentLogicStateVisible == 0) {
					me._popup_video_file0.style.visibility=(Number(me._popup_video_file0.style.opacity)>0||!me._popup_video_file0.style.opacity)?'inherit':'hidden';
					if (me._popup_video_file0.ggVideoNotLoaded) {
						me._popup_video_file0.ggInitMedia(me._popup_video_file0.ggVideoSource);
					}
					me._popup_video_file0.ggVisible=true;
				}
				else {
					me._popup_video_file0.style.visibility="hidden";
					me._popup_video_file0.ggInitMedia('');
					me._popup_video_file0.ggVisible=false;
				}
			}
		}
		me._popup_video_file0.ggUpdatePosition=function (useTransition) {
		}
		me._video_popup_file0.appendChild(me._popup_video_file0);
		me.divSkin.appendChild(me._video_popup_file0);
		el=me._video_popup_controls_file0=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._video_popup_controls_file0.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._video_popup_controls_file0.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				(player.getVariableValue('vis_video_popup_file') == true)
			)
			...
			if (me._video_popup_controls_file0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._video_popup_controls_file0.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._video_popup_controls_file0.style[domTransition]='';
				if (me._video_popup_controls_file0.ggCurrentLogicStateVisible == 0) {
					me._video_popup_controls_file0.style.visibility=(Number(me._video_popup_controls_file0.style.opacity)>0||!me._video_popup_controls_file0.style.opacity)?'inherit':'hidden';
					me._video_popup_controls_file0.ggVisible=true;
				}
				else {
					me._video_popup_controls_file0.style.visibility="hidden";
					me._video_popup_controls_file0.ggVisible=false;
				}
			}
		}
		me._video_popup_controls_file0.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._seekbar_file0=document.createElement('div');
		me._seekbar_file0__playhead=document.createElement('div');
		me._seekbar_file0.mediaEl = null;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._seekbar_file0.connectToMediaEl = function() {
			var disableSeekbar = function() {
				me._seekbar_file0__playhead.style.visibility = 'hidden';
				me._seekbar_file0.style.background = '#ffffff';
				me._seekbar_file0.ggConnected = false;
			}
			if (me._seekbar_file0.mediaEl != null) {
				me._seekbar_file0.mediaEl.removeEventListener('progress', me._seekbar_file0.updatePlayback);
				me._seekbar_file0.mediaEl.removeEventListener('canplay', me._seekbar_file0.updatePlayback);
				me._seekbar_file0.mediaEl.removeEventListener('timeupdate', me._seekbar_file0.updatePlayback);
				if (me._seekbar_file0.ggActivate) {
					me._seekbar_file0.mediaEl.removeEventListener('play', me._seekbar_file0.ggActivate);
				}
				if (me._seekbar_file0.ggDeactivate) {
					me._seekbar_file0.mediaEl.removeEventListener('ended', me._seekbar_file0.ggDeactivate);
					me._seekbar_file0.mediaEl.removeEventListener('pause', me._seekbar_file0.ggDeactivate);
				}
				if (me._seekbar_file0.ggMediaEnded) {
					me._seekbar_file0.mediaEl.removeEventListener('ended', me._seekbar_file0.ggMediaEnded);
				}
			}
			me._seekbar_file0.mediaEl = player.getMediaObject('popup_video_file');
			if (me._seekbar_file0.mediaEl != null) {
				me._seekbar_file0__playhead.style.visibility = 'inherit';
				me._seekbar_file0__playhead.style.left = '1px';
				me._seekbar_file0.mediaEl.addEventListener('progress', me._seekbar_file0.updatePlayback);
				me._seekbar_file0.mediaEl.addEventListener('canplay', me._seekbar_file0.updatePlayback);
				me._seekbar_file0.mediaEl.addEventListener('timeupdate', me._seekbar_file0.updatePlayback);
				if (me._seekbar_file0.ggActivate) {
					me._seekbar_file0.mediaEl.addEventListener('play', me._seekbar_file0.ggActivate);
				}
				if (me._seekbar_file0.ggDeactivate) {
					me._seekbar_file0.mediaEl.addEventListener('ended', me._seekbar_file0.ggDeactivate);
					me._seekbar_file0.mediaEl.addEventListener('pause', me._seekbar_file0.ggDeactivate);
				}
				if (me._seekbar_file0.ggMediaEnded) {
					me._seekbar_file0.mediaEl.addEventListener('ended', me._seekbar_file0.ggMediaEnded);
				}
			me._seekbar_file0.ggConnected = true;
			} else {
				disableSeekbar();
			}
		...
		me._seekbar_file0.updatePlayback = function() {
			if (!me._seekbar_file0.ggConnected) return;
			if (me._seekbar_file0.mediaEl != null) {
				if (me._seekbar_file0.mediaEl.readyState) {
					var percent = me._seekbar_file0.mediaEl.currentTime / me._seekbar_file0.mediaEl.duration;
					var playheadpos = Math.round((me._seekbar_file0.clientWidth - 2 * 8 + 1) * percent);
					playheadpos += 1;
					me._seekbar_file0__playhead.style.left = playheadpos.toString() + 'px';
					var offsetPercent = Math.round(100.0 * (8 / me._seekbar_file0.clientWidth));
					var currPos = offsetPercent + Math.round(percent * (100 - 2 * offsetPercent));
					var gradientString ='linear-gradient(90deg, #808080 0%, #808080 ' + currPos + '%';
					for (var i = 0; i < me._seekbar_file0.mediaEl.buffered.length; i++) {
						var rangeStart = Math.round((me._seekbar_file0.mediaEl.buffered.start(i) / me._seekbar_file0.mediaEl.duration) * 100.0);
						var rangeEnd = Math.ceil((me._seekbar_file0.mediaEl.buffered.end(i) / me._seekbar_file0.mediaEl.duration) * 100.0);
						if (rangeEnd > currPos) {
					...
					gradientString += ')';
					me._seekbar_file0.style.background = gradientString;
				}
			}
		}
		me._seekbar_file0.appendChild(me._seekbar_file0__playhead);
		...
		me._seekbar_file0.setAttribute('style', hs);
		me._seekbar_file0__playhead.setAttribute('style', hs_playhead);
		me._seekbar_file0.ggIsActive=function() {
			if (me._seekbar_file0.mediaEl != null) {
				return (me._seekbar_file0.mediaEl.paused == false && me._seekbar_file0.mediaEl.ended == false);
			} else {
				return false;
			}
		}
		...
		me._seekbar_file0.onmousedown=function (e) {
			if (e.buttons == 1 || (e.buttons == null && e.which == 1) || e.type == 'touchend') {
				if (me._seekbar_file0.mediaEl != null) {
					var eventXPos;
					if(e.type == 'touchend') eventXPos = e.layerX; else eventXPos = e.offsetX;
					var seekpos = (eventXPos / me._seekbar_file0.clientWidth) * me._seekbar_file0.mediaEl.duration;
					me._seekbar_file0.mediaEl.currentTime = seekpos;
				}
			}
		}
		me._seekbar_file0.onmousemove=function (e) {
			if (e.buttons == 1 || (e.buttons == null && e.which == 1) || e.type == 'touchend') {
				if (me._seekbar_file0.mediaEl != null) {
					var eventXPos;
					if(e.type == 'touchend') eventXPos = e.layerX; else eventXPos = e.offsetX;
		...
		me._seekbar_file0.ontouchend=function (e) {
			if (e.buttons == 1 || (e.buttons == null && e.which == 1) || e.type == 'touchend') {
				if (me._seekbar_file0.mediaEl != null) {
					var eventXPos;
					if(e.type == 'touchend') eventXPos = e.layerX; else eventXPos = e.offsetX;
		...
		me._seekbar_file0.ggActivate=function () {
			me._ht_video_pause_file0.style[domTransition]='none';
			me._ht_video_pause_file0.style.visibility=(Number(me._ht_video_pause_file0.style.opacity)>0||!me._ht_video_pause_file0.style.opacity)?'inherit':'hidden';
			me._ht_video_pause_file0.ggVisible=true;
			me._ht_video_play_file0.style[domTransition]='none';
			me._ht_video_play_file0.style.visibility='hidden';
			me._ht_video_play_file0.ggVisible=false;
		}
		me._seekbar_file0.ggDeactivate=function () {
			me._ht_video_play_file0.style[domTransition]='none';
			me._ht_video_play_file0.style.visibility=(Number(me._ht_video_play_file0.style.opacity)>0||!me._ht_video_play_file0.style.opacity)?'inherit':'hidden';
			me._ht_video_play_file0.ggVisible=true;
			me._ht_video_pause_file0.style[domTransition]='none';
			me._ht_video_pause_file0.style.visibility='hidden';
			me._ht_video_pause_file0.ggVisible=false;
		}
		me._seekbar_file0.ggUpdatePosition=function (useTransition) {
		}
		me._seekbar_file0.ggNodeChange=function () {
			me._seekbar_file0.connectToMediaEl();
		}
		me._video_popup_controls_file0.appendChild(me._seekbar_file0);
		el=me._ht_video_play_file0=document.createElement('div');
		els=me._ht_video_play_file0__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_play_file0__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_play_file0;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_video_play_file0__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_play_file0__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_play_file0;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_play_file0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_play_file0.onclick=function (e) {
		...
		me._ht_video_play_file0.onmouseover=function (e) {
			me._ht_video_play_file0__img.style.visibility='hidden';
			me._ht_video_play_file0__imgo.style.visibility='inherit';
		}
		me._ht_video_play_file0.onmouseout=function (e) {
			me._ht_video_play_file0__img.style.visibility='inherit';
			me._ht_video_play_file0__imgo.style.visibility='hidden';
		}
		me._ht_video_play_file0.ggUpdatePosition=function (useTransition) {
		}
		me._video_popup_controls_file0.appendChild(me._ht_video_play_file0);
		el=me._ht_video_pause_file0=document.createElement('div');
		els=me._ht_video_pause_file0__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_pause_file0__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_pause_file0;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_video_pause_file0__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_video_pause_file0__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_pause_file0;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_video_pause_file0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_video_pause_file0.onclick=function (e) {
		...
		me._ht_video_pause_file0.onmouseover=function (e) {
			me._ht_video_pause_file0__img.style.visibility='hidden';
			me._ht_video_pause_file0__imgo.style.visibility='inherit';
		}
		me._ht_video_pause_file0.onmouseout=function (e) {
			me._ht_video_pause_file0__img.style.visibility='inherit';
			me._ht_video_pause_file0__imgo.style.visibility='hidden';
		}
		me._ht_video_pause_file0.ggUpdatePosition=function (useTransition) {
		}
		me._video_popup_controls_file0.appendChild(me._ht_video_pause_file0);
		me.divSkin.appendChild(me._video_popup_controls_file0);
	...
	function SkinHotspotClass_ht_video_file(parentScope,hotspot) {
		...
		me._ht_video_file.onclick=function (e) {
			skin._popup_video_file0.ggInitMedia(player.getBasePath()+""+me.hotspot.url);
	...
	me._video_popup_file0.logicBlock_visible();
	me._popup_video_file0.logicBlock_visible();
	me._video_popup_controls_file0.logicBlock_visible();
	...
	player.addListener('varchanged_vis_video_popup_file', function(args) { me._show_controller_button.logicBlock_position();me._screentint.logicBlock_alpha();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._video_popup_file0.logicBlock_visible();me._popup_video_file0.logicBlock_visible();me._video_popup_controls_file0.logicBlock_visible();me._close.logicBlock_visible(); });
	...
	player.addListener('changenodeid', function(args) { me.callChildLogicBlocksHotspot_ht_node_changenodeid();me.callChildLogicBlocksHotspot_ht_url_changenodeid();me.callChildLogicBlocksHotspot_ht_info_changenodeid();me.callChildLogicBlocksHotspot_ht_image_changenodeid();me.callChildLogicBlocksHotspot_ht_video_url_changenodeid();me.callChildLogicBlocksHotspot_ht_video_vimeo_changenodeid();me.callChildLogicBlocksHotspot_ht_video_youtube_changenodeid();me.callChildLogicBlocksHotspot_ht_video_file_changenodeid(); });
	player.addListener('configloaded', function(args) { me.callChildLogicBlocksHotspot_ht_node_configloaded();me.callChildLogicBlocksHotspot_ht_url_configloaded();me.callChildLogicBlocksHotspot_ht_info_configloaded();me.callChildLogicBlocksHotspot_ht_image_configloaded();me.callChildLogicBlocksHotspot_ht_video_url_configloaded();me.callChildLogicBlocksHotspot_ht_video_vimeo_configloaded();me.callChildLogicBlocksHotspot_ht_video_youtube_configloaded();me.callChildLogicBlocksHotspot_ht_video_file_configloaded(); });
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_ht_node_mouseover();me.callChildLogicBlocksHotspot_ht_url_mouseover();me.callChildLogicBlocksHotspot_ht_info_mouseover();me.callChildLogicBlocksHotspot_ht_image_mouseover();me.callChildLogicBlocksHotspot_ht_video_url_mouseover();me.callChildLogicBlocksHotspot_ht_video_vimeo_mouseover();me.callChildLogicBlocksHotspot_ht_video_youtube_mouseover();me.callChildLogicBlocksHotspot_ht_video_file_mouseover(); });
	...
	player.addListener('varchanged_vis_video_popup_file', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_video_url_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_video_vimeo_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_video_youtube_varchanged_vis_video_popup_file(); });
